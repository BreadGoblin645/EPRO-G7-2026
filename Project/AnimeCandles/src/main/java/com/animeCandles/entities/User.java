...
public class User {
	...
	public User(String userName, String userEmail, String userPassword, String userPhone, String userGender,
			String userAddress, String userCity, String userZipcode, String userState) {
		super();
	...
	public User(String userName, String userEmail, String userPassword, String userPhone, String userGender,
			Timestamp dateTime, String userAddress, String userCity, String userZipcode, String userState) {
		super();
		this.userName = userName;
		this.userEmail = userEmail;
		this.userPassword = userPassword;
	...
	public User(String userName, String userEmail, String userPhone, String userGender, String userAddress,
			String userCity, String userZipcode, String userState) {
		super();
		this.userName = userName;
		this.userEmail = userEmail;
		this.userPhone = userPhone;
